...
from Application.Utils.createTables import tables_details_BWSWM


class BranchScriptSummary(QMainWindow):
    ################################# Intialization Here ##################################################
    def __init__(self):

        super(BranchScriptSummary, self).__init__()
