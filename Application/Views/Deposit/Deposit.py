...
from Application.Utils.createTables import tables_details_Deposit
...
class UI_Deposit(QMainWindow):
    ...
    def __init__(self):
        ...
        super(UI_Deposit, self).__init__()
        self.osType = platform.system()
        #########################################################
        ########################################################
        #########################################################
        loc1 = os.getcwd().split('Application')
        ui_login = os.path.join(loc1[0], 'Resources', 'UI', 'Deposit.ui')
